                ...
                @foreach ($categories as $category)
                    <tr>
                        ...
                        <td class="d-flex flex-column flex-sm-row gap-1">
                            {{-- Read --}}
                            <a href="/dashboard/categories/{{ $category->slug }}" class="badge bg-primary p-1"><span
                                    data-feather="eye"></span></a>
                            {{-- Edit --}}
                            <a href="/dashboard/categories/{{ $category->slug }}/edit" class="badge bg-warning p-1"><span
